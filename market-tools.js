    ...
    try{
      ...
      box.innerHTML=`
        ...
        <div class="rate-source-row">
          ...
          <a href="${esc(d.sourceUrl||'https://www.cmegroup.com/markets/interest-rates/cme-fedwatch-tool.html')}" target="_blank" rel="noopener">${d.sourceMode==='cloudflare-cron-calculated'?'CME FedWatch methodology ↗':'View source ↗'}</a>
        </div>`;
